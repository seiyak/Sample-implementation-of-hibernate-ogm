...
public class HibernateCoreAPIWrappingTest extends JpaTestCase {
	...
	private static Logger log = Logger
			.getLogger(HibernateCoreAPIWrappingTest.class);
	...
	public void testWrappedFromEntityManagerAPI() throws Exception {
		...
		final EntityManagerFactory emf = Persistence
				.createEntityManagerFactory("jpajtastandalone");
		assertThat(
				HibernateEntityManagerFactory.class.isAssignableFrom(emf
						.getClass())).isTrue();
		SessionFactory factory = ((HibernateEntityManagerFactory) emf)
				.getSessionFactory();
		assertThat(factory.getClass()).isEqualTo(OgmSessionFactory.class);

		Session s = factory.openSession();
		assertThat(s.getClass()).isEqualTo(OgmSession.class);
		assertThat(s.getSessionFactory().getClass()).isEqualTo(
				OgmSessionFactory.class);

		Cavalier cavalier = new Cavalier();
		cavalier.setName("Caroline");

		EntityManager em = emf.createEntityManager();
		assertThat(em.unwrap(Session.class).getClass()).isEqualTo(
				OgmSession.class);
	...
	private void buildArchive() throws MalformedURLException {
		...
		archive.addClass(Cavalier.class);
	...
	public void testJNDIReference() throws Exception {
		...
		assertThat(reference.getClassName()).isEqualTo(
				OgmSessionFactory.class.getName());
		assertThat(reference.getFactoryClassName()).isEqualTo(
		...
		SessionFactory factoryFromRegistry = (SessionFactory) objFactory
				.getObjectInstance(reference, null, null, null);
		assertThat(factoryFromRegistry.getClass()).isEqualTo(
				OgmSessionFactory.class);
		assertThat(factoryFromRegistry.getReference()).isEqualTo(
