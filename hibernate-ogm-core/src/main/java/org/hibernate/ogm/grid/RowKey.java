...
public final class RowKey implements Serializable {
	...
	// column value types do have to be serializable so RowKey can be
	// serializable
	...
	/**
	 * Gets table name that this owns.
	 * 
	 * @return Table name.
	 */
	...
	public String toString() {
		...
		sb.append(", columns=").append(
				columns == null ? "null" : Arrays.asList(columns).toString());
		sb.append(", columnValues=").append(
				columnValues == null ? "null" : Arrays.asList(columnValues)
						.toString());
		sb.append('}');
		return sb.toString();
	}
