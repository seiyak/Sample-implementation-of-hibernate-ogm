...
/**
 * Delegate most of the work to the underlying Hibernate Session except that
 * queries are redirected to our own engine
 * 
...
public class OgmSession implements org.hibernate.Session, EventSource {
	...
	private static Logger log = Logger.getLogger(OgmSession.class);
	...
	public Criteria createCriteria(Class persistentClass) {
		...
		// return new OgmCriteria(this.delegate, this.factory, persistentClass);
	}

	@Override
	public Criteria createCriteria(Class persistentClass, String alias) {
		// TODO plug the Lucene engine
		throw new NotSupportedException("OGM-23",
				"Criteria queries are not supported yet");
	}
	...
	public Query createQuery(String queryString) throws HibernateException {
		// TODO plug the Lucene engine
		throw new NotSupportedException("OGM-22",
				"JP-QL queries are not supported yet");
	}
	...
	public SQLQuery createSQLQuery(String queryString)
		...
		throw new IllegalStateException(
				"Hibernate OGM does not support native queries");
	}
	...
	public Query createFilter(Object collection, String queryString)
			throws HibernateException {
		// TODO plug the Lucene engine
		throw new NotSupportedException("OGM-24",
				"filters are not supported yet");
	}

	@Override
	public Filter enableFilter(String filterName) {
		throw new NotSupportedException("OGM-25",
				"filters are not supported yet");
	}
	...
	public void doWork(Work work) throws HibernateException {
		throw new IllegalStateException(
				"Hibernate OGM does not support SQL Connections hence no Work");
	}
	...
	public void delete(String entityName, Object child,
		...
		delegate.delete(entityName, child, isCascadeDeleteEnabled,
				transientEntities);
	}
	...
	public SharedSessionBuilder sessionWithOptions() {
		return new OgmSharedSessionBuilderDelegator(
				delegate.sessionWithOptions(), factory);
	}
	...
	public Serializable save(Object object) throws HibernateException {
		log.info("save " + object.getClass().getSimpleName());
	...
	public void update(Object object) throws HibernateException {
		log.info("updating " + object.getClass().getCanonicalName());
	...
	public void persist(Object object) throws HibernateException {
		...
		log.info("Making the entity managed, "
	...
	public void delete(Object object) throws HibernateException {
		...
		log.info("Detaching the entity, " + object.getClass().getSimpleName());
	...
	public Object get(Class clazz, Serializable id) throws HibernateException {
		log.info("get " + clazz.getSimpleName() + " by id " + id);
